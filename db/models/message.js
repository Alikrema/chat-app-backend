  ...
  Message.init(
    {
      ...
      userId: {
        // Renamed from 'sender_id' to match the 'userId' column in the table
        type: DataTypes.INTEGER,
        allowNull: false,
      },
      chatRoomId: {
        // Renamed from 'group_id' to match the 'chatRoomId' column in the table
        type: DataTypes.INTEGER,
        allowNull: false,
      },
      createdAt: {
        // Ensuring this matches the table, including using timestamp with time zone
        type: DataTypes.DATE, // Sequelize will map this to timestamp with time zone
        allowNull: false,
        defaultValue: DataTypes.NOW,
      },
      updatedAt: {
        // Added this to match the table schema
        type: DataTypes.DATE, // Sequelize will map this to timestamp with time zone
        allowNull: false,
      },
    },
